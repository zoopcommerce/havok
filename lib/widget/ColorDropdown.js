    ...
    return declare([DropdownBase, WidgetsInTemplateMixin],
        {
            ...
            startup: function(){
                ...
                var hexWatch;
                this.addHandler(this.hex.on('focus', lang.hitch(this, function(){
                ...
                this.addHandler(this.hex.on('blur', function(){
                    hexWatch.unwatch();
                }));
                this.addHandler(this.watch('hidden', lang.hitch(this, function(p, o, n){
