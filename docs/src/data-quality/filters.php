        ...
        <section id="filters" title="Filters">
          ...
          <div class="bs-docs-example" class="form-horizontal">
             ...
             <div class="well">
                 <button id="trimButton" class="btn">filter</button>
...
var trim = new Trim,
    filteredValue = trim.filter(value);
          ...
          <div class="bs-docs-example" class="form-horizontal">
             ...
             <div class="well">
                 <button id="lowercaseButton" class="btn">filter</button>
...
var lowercase = new Lowercase,
    filteredValue = lowercase.filter(value);
          ...
          <div class="bs-docs-example" class="form-horizontal">
             ...
             <div class="well">
                 <button id="uppercaseButton" class="btn">filter</button>
...
var uppercase = new Uppercase,
    filteredValue = uppercase.filter(value);
          ...
          <div class="bs-docs-example" class="form-horizontal">
             ...
             <div class="well">
                 <button id="propercaseButton" class="btn">filter</button>
...
var propercase = new propercase,
    filteredValue = propercase.filter(value);
          ...
          <div class="bs-docs-example" class="form-horizontal">
             ...
             <div class="well">
                 <button id="chainButton" class="btn">filter</button>
...
var chain = new Chain({filters: [
    ...
    filteredValue = chain.filter(value);
          ...
          <div class="bs-docs-example" class="form-horizontal">
             ...
             <div class="well">
                 <button id="customButton" class="btn">filter</button>
   ...
   function(FilterBase, declare){
       ...
       filteredValue = dollar.filter(value);
          ...
          <div class="bs-docs-example" class="form-horizontal">
             ...
             <div class="well">
                 <button id="factoryButton" class="btn">filter</button>
