...
git clone http://github.com/zoopcommerce/mystique mystique-common
    ...
    <p>Havok will normally work with the latest development versions of dojo and mystique. But if you want to be 100% sure, check the versions specified in composer.json, and check those tags out in the respective repos.</p>
