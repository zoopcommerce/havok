...
(this.dojoConfig || this.djConfig || this.require || {}, {
		...
		di:{
				'havok/exception/Handler':{
					 gets:{renderers:["havok/exception/renderer/Console"]},
					 proxyMethods:[
					 		"set",
					 		"handle"
					 ]
				},
				'havok/filter/Chain':{directives:{cache:false}},
				'havok/filter/factory':{gets:{di:"havok/di/sharedDi!"}},
				'havok/router/router':{
					 gets:{di:"havok/di/sharedDi!"},
					 params:{routes:[
					 				{
					 					 ignore:true,
				...
				'havok/store/manager':{
					 gets:{stores:"havok/store/stores"},
					 proxyMethods:[
					 		"get",
					 		"getStore"
					 ]
				...
				'havok/validator/factory':{gets:{di:"havok/di/sharedDi!"}},
				'mystique/Chain':{directives:{cache:false}}
		},
		hasCache:{
...
function () {
    ...
    //
    // summary:
    //      Requires everything in the havok package. Great for rapid development and testing,
    //      but probably more than you need in production.
    //
});

},
'havok/array':function(){
define ([
    'dojo/_base/array'
],
function (array) {
...
if (typeof transform(value, key) == 'undefined'){
    var a = 1;
}
...
'havok/config/exception/notStatic':function(){
define([
    'dojo/errors/create',
...
'havok/exception/severity':function(){
define([],
function(){
	return {
        NOTICE   : 1,
...
function () {
    ...
    //
    // summary:
    //      Requires all di modules
    //
});

},
'havok/di/Di':function(){
define([
        'dojo/_base/declare',
        'dojo/_base/config',
        'dojo/Deferred',
...
function (
    ...
    //
    // summary:
    //      Requires all exception modules
    //
});

},
'havok/exception/started':function(){
define([
    '../get!./Handler'
],
function(
...
'havok/exception/Handler':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    './severity',
...
'havok/exception/Application':function(){
define([
    'dojo/errors/create',
    './Base'
],
...
'havok/exception/renderer/Console':function(){
define([
    'dojo/_base/declare'
],
function(
...
function (
    ...
    //
    // summary:
    //      Requires all filter modules
    //
});

},
'havok/filter/Chain':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/Deferred',
...
'havok/filter/CleanHTML':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    './Base'
...
'havok/filter/Currency':function(){
define([
    'dojo/_base/declare',
    'dojo/number',
    'dojo/cldr/monetary',
...
'havok/filter/HexColor':function(){
define([
    'dojo/_base/declare',
    './Base'
],
...
'havok/filter/Lowercase':function(){
define([
    'dojo/_base/declare',
    './Base'
],
...
'havok/filter/Propercase':function(){
define([
    'dojo/_base/declare',
    './Base'
],
...
'havok/filter/Uppercase':function(){
define([
    'dojo/_base/declare',
    './Base'
],
...
function (
    ...
    //
    // summary:
    //      Requires all router modules
    //
});

},
'havok/router/started':function(){
define([
    '../get!./router'
],
function(
...
'havok/router/exception/RouteNotFound':function(){
define([
    'dojo/_base/lang',
    'dojo/errors/create',
    '../../exception/Base'
...
'havok/widget/Accordion':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/fx',
    'dojo/fx',
...
'havok/widget/_WidgetBase':function(){
define([
    'dojo/_base/declare',
    'dojo/dom-class',
    'dijit/_WidgetBase',
...
'havok/widget/_AffixMixin':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/on',
...
'havok/widget/ButtonGroup':function(){
define([
    'dojo/_base/declare',
    'dojo/string',
    'dojo/dom-class',
...
'havok/widget/_StoreMixin':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/Deferred',
...
'havok/widget/_ListMixin':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/Deferred',
...
'havok/widget/CheckboxGroup':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/_base/array',
...
'havok/widget/Dragable':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/query',
...
'havok/widget/Dropdown':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/_base/array',
...
'havok/widget/DropdownSubmenu':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/array',
    '../string',
...
'havok/widget/DropdownToggle':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/_base/array',
...
'havok/widget/_HideableMixin':function(){
define([
    'dojo/_base/declare'
],
function(
...
'havok/widget/_DropdownBase':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/dom-construct',
...
'havok/widget/NavBarLinks':function(){
define([
    'dojo/_base/declare',
    './_NavBase',
...
'havok/widget/_NavBase':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/_base/array',
    ...
    return declare(
        [NavBase],
        {
            buildRendering: function(){
                ...
                domClass.add(this.containerNode, 'nav-tabs');
            }
        }
    );
});
...
'havok/widget/RadioGroup':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/when',
...
'havok/widget/TabContainer':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/dom-construct',
...
'havok/widget/_SortableMixin':function(){
define([
    'dojo/_base/declare',
    'dojo/on',
    'dojo/_base/lang',
...
'havok/widget/ToggleButton':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/dom-class',
...
'havok/widget/_KeypressMixin':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/_base/array',
...
'havok/widget/_ScrollSpyMixin':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/dom-attr',
...
'havok/docs/module/Formspy':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/json',
...
'havok/docs/module/Controller':function(){
define([
    'dojo/_base/declare',
    'dojo/_base/lang',
    'dojo/_base/array',
...
'havok/docs/module/MultiFieldValidator':function(){
define([
    'mystique/Base',
    'mystique/Result'
],
...
'mystique/nls/messages':function(){
define({ root:
{
    ...
    "greaterThan": "Must be greater than ${1}",
    "greaterThanEqual": "Must be greater than or equal to ${1}",
    "hexColor": "Must be a valid RGB color hex",
    "int": "Must be a valid while number",
    "length": "Must be between ${1} and ${2} characters long",
    "lessThan": "Must be less than ${1}",
    "lessThanOrEqual": "Must be less than or equal to ${1}",
    "notEqual": "Must not be equal to ${1}",
    "passwordLength": "Must be between 6 and 40 characters long.",
    "passwordAlpha": "Must contain at least one alpha character (a-z, A-Z)",
    "passwordNum": "Must contain at least one numeric character (0-9)",
    "regex": "Must match the {$1} pattern",
    "required": "This value is required",
    "slug": "Must contain only the characters a-z, 0-9, or -, and between ${1} and ${2} characters long",
    "string": "This value must be text"
}
});

},
'url:havok/widget/template/WidgetBase.html':"<${tag} data-dojo-attach-point=\"containerNode\">\n</{tag}>",
'url:havok/widget/template/AccordionItem.html':"<div title=\"${title}\" class=\"accordion-group\">\n<div class=\"accordion-heading\">\n<a class=\"accordion-toggle\" data-dojo-attach-point=\"toggle\">${title}</a>\n</div>\n<div data-dojo-attach-point=\"body\" class=\"accordion-body collapse\">\n<div data-dojo-attach-point=\"containerNode\" class=\"accordion-inner\">\n</div>\n</div>\n</div>\n",
'url:havok/vendor/bootstrap/less/accordion.less':'//skip',
'url:havok/vendor/bootstrap/less/variables.less':'//skip',
'url:havok/vendor/bootstrap/less/mixins.less':'//skip',
'url:havok/vendor/bootstrap/less/reset.less':'//skip',
'url:havok/vendor/bootstrap/less/scaffolding.less':'//skip',
'url:havok/vendor/bootstrap/less/grid.less':'//skip',
'url:havok/vendor/bootstrap/less/layouts.less':'//skip',
'url:havok/vendor/bootstrap/less/type.less':'//skip',
'url:havok/vendor/bootstrap/less/code.less':'//skip',
'url:havok/vendor/bootstrap/less/forms.less':'//skip',
'url:havok/vendor/bootstrap/less/tables.less':'//skip',
'url:havok/vendor/bootstrap/less/utilities.less':'//skip',
'url:havok/vendor/bootstrap/less/responsive-utilities.less':'//skip',
'url:havok/vendor/bootstrap/less/responsive-1200px-min.less':'//skip',
'url:havok/vendor/bootstrap/less/responsive-768px-979px.less':'//skip',
'url:havok/vendor/bootstrap/less/responsive-767px-max.less':'//skip',
'url:havok/vendor/bootstrap/less/responsive-navbar.less':'//skip',
'url:havok/vendor/font-awesome/less/variables.less':'//skip',
'url:havok/vendor/font-awesome/less/mixins.less':'//skip',
'url:havok/vendor/font-awesome/less/path.less':'//skip',
'url:havok/vendor/font-awesome/less/core.less':'//skip',
'url:havok/vendor/font-awesome/less/bootstrap.less':'//skip',
'url:havok/vendor/font-awesome/less/extras.less':'//skip',
'url:havok/vendor/font-awesome/less/icons.less':'//skip',
'url:havok/docs/src/less/variables.less':'//skip',
'url:havok/vendor/bootstrap/less/labels-badges.less':'//skip',
'url:havok/vendor/bootstrap/less/wells.less':'//skip',
'url:havok/docs/src/less/docs.less':'//skip',
'url:havok/vendor/bootstrap/less/component-animations.less':'//skip',
'url:havok/widget/template/Button.html':"<button data-dojo-attach-point=\"button\" class=\"btn\">${!text}</button>",
'url:havok/vendor/bootstrap/less/buttons.less':'//skip',
'url:havok/vendor/bootstrap/less/button-groups.less':'//skip',
'url:havok/widget/less/dragable.less':'//skip',
'url:havok/widget/template/DropdownBase.html':"<${tag}\naria-labelledby=\"dropdownMenu\"\ndata-dojo-attach-event=\"mouseenter: onMouseenter, mouseleave: onMouseleave\"\nrole=\"menu\"\ndata-dojo-attach-point=\"containerNode\"\n>\n</${tag}>",
'url:havok/widget/less/dropdowns.less':'//skip',
'url:havok/widget/template/DropdownLink.html':"<a role=\"dropdownitem\" tabindex=\"-1\" href=\"${href}\">${text}</a>",
'url:havok/widget/template/Divider.html':"<li class=\"divider\"></li>",
'url:havok/widget/template/NavHeader.html':"<li class=\"nav-header\">${text}</li>",
'url:havok/widget/template/NavBar.html':"<div class=\"navbar\">\n<div class=\"navbar-inner\" data-dojo-attach-point=\"containerNode\">\n</div>\n</div>",
'url:havok/vendor/bootstrap/less/navbar.less':'//skip',
'url:havok/widget/template/NavLink.html':"<a role=\"navitem\" href=\"${href}\">${text}</a>",
'url:havok/vendor/bootstrap/less/navs.less':'//skip',
'url:havok/widget/template/NavBarLinksDivider.html':"<li class=\"divider-vertical\"></li>",
'url:havok/widget/template/Overlay.html':"<span>\n<div class=\"hide\" data-dojo-attach-point=\"overlay\">\n<div class=\"overlay-overlay\" data-dojo-attach-point=\"backdrop\"></div>\n<div class=\"overlay-content\" data-dojo-attach-point=\"containerNode\"></div>\n</div>\n</span>",
'url:havok/widget/less/overlay.less':'//skip',
'url:havok/widget/template/TabContainer.html':"<div class=\"tabbable\">\n<div class=\"tab-content\" data-dojo-attach-point=\"containerNode\">\n</div>\n</div>",
'url:havok/docs/module/template/Formspy.html':"<div>\n<div data-dojo-attach-point=\"containerNode\"></div>\n<div class=\"well well-small\">\n<p><b>state:</b></p>\n<pre data-dojo-attach-point=\"state\"></pre>\n<p><b>value:</b></p>\n<pre data-dojo-attach-point=\"value\"></pre>\n</div>\n</div>\n",
'*now':function(r){r(['dojo/i18n!*preload*havok/nls/havokdocs*["ar","ca","cs","da","de","el","en-gb","es-es","fi-fi","fr-fr","he-il","hu","it-it","ja-jp","ko-kr","nl-nl","nb","pl","pt-br","pt-pt","ru","sk","sl","sv","th","tr","zh-tw","zh-cn"]']);}
}});
(function(){
